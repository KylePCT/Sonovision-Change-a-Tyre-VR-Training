...
public class ControllerManager : MonoBehaviour
{
    ...
    void Update()
    {
        if (m_LeftController.isValid)
        {
            ...
            if (m_LeftController.TryGetFeatureValue(CommonUsages.trigger, out float triggerValue))
            {
            ...
            if (m_LeftController.TryGetFeatureValue(CommonUsages.grip, out float gripValue))
            {
        ...
        if (m_RightController.isValid)
        {
            ...
            if (m_RightController.TryGetFeatureValue(CommonUsages.trigger, out float triggerValue))
            {
                handAnimator.SetFloat("Trigger", triggerValue);
            }
            ...
            if (m_RightController.TryGetFeatureValue(CommonUsages.grip, out float gripValue))
            {
                handAnimator.SetFloat("Grip", gripValue);
            }
            else
